...
public class RelaxedPlanVector {
	...
	/**
	 * Construct a randomized vector with no reference to the space (for initial
	 * cluster centroids)
	 */
	...
	/*
	 * public RelaxedPlanVector plus(RelaxedPlanVector other) { RelaxedPlanVector
	 * newVector = new RelaxedPlanVector(allActions); // if (values.length !=
	 * other.values.length) // throw new
	 * Exception("Relaxed PLan Vectors are not of equal length");
	 * 
	 * for (int i = 0; i < actionValues.length; i++) newVector.actionValues[i] =
	 * actionValues[i] + other.actionValues[i];
	 * 
	 * return newVector; }
	 * 
	 * public RelaxedPlanVector minus(RelaxedPlanVector other) { RelaxedPlanVector
	 * newVector = new RelaxedPlanVector(allActions); // if (values.length !=
	 * other.values.length) // throw new
	 * Exception("Relaxed PLan Vectors are not of equal length");
	 * 
